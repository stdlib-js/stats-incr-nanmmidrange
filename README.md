...
```javascript
incrnanmmidrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmmidrange@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrnanmmidrange = require( 'path/to/vendor/umd/stats-incr-nanmmidrange/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmmidrange@umd/browser.js"></script>
```
